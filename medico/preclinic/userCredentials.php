            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-7 col-6">
                        <h4 class="page-title">User Credentials</h4>
                    </div>
...
-->                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <small class="text-muted">Role : Patient</small>
                                                <div class="staff-id">Patient ID : <?php echo $row['patient_id']; ?></div>
                                                <div class="staff-msg"><a href="update.php?appid=<?=$appid?>&pid=<?=$pid?>" class="btn btn-primary">Consulted</a></div>
                                            </div>
                                        </div>
				...
				<div class="profile-tabs">
					<ul class="nav nav-tabs nav-tabs-bottom">
						...
						<li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-toggle="tab">Prescription</a></li>
						<li class="nav-item"><a class="nav-link" href="#bottom-tab3" data-toggle="tab">Test</a></li>
					</ul>
	...
	$date=date("Y-m-d");
    $SuccMessage="Prescribed  Succesfully!!";
...
?>
						...
						<form method="post">
							...
							<br><br>
							<button class="btn btn-primary submit-btn" name="submitTest">Submit</button>
							</form>
    ...
    $test=$_POST['test'];
	$date=date("Y-m-d");
    $SuccMessage="Test Added  Succesfully!!";

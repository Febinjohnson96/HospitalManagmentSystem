            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
						...
						<img class="rounded-circle" src="Images/<?php echo $row['UserPic']?>" width="40" alt="Admin">
...
//					$row = mysqli_fetch_array($result);
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="Images/<?php echo $row['UserPic']?>" alt=""></a>
                                    </div>
                                </div>
                ...
                <div class="row">
					...
					$sql_pre= "SELECT * FROM `prescription` WHERE patient_id ='$patientId'";  
				...
				?>
					...
					$sql_test= "SELECT * FROM `test` WHERE patient_id ='$patientId'";  

            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="emploprofile.php">My Profile</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo $row['empName']; ?></h3>
                                                <small class="text-muted">Role : Employee</small>
                                                <div class="staff-id">Employee ID : <?php echo $row['emp_id']; ?></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $row['empStatus']; ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>

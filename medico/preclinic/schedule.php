...
<!-- Mirrored from dreamguys.co.in/preclinic/template/schedule.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:44 GMT -->
<head>
    <meta charset="utf-8">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
                          ...
                          {  
						  $temp =$row["schedule_id"];
						  ?>  
									<tr>
										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <?php echo $row['doctorName']; ?></td>
										<td><?php echo $row['department_name']; ?></td>
										<td><?php echo $row['availDays']; ?></td>
										<td><?php echo $row['startTime']; ?> To <?php echo $row['endTime']; ?></td>
										<td>
										<?php	if($row['status'] == "Active"){ ?>
										<span class="custom-badge status-green">Active</span>
										<?php } else {?><span class="custom-badge status-red">Inactive</span> <?php }?>
										</td>
										<td class="text-right">
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/schedule.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:45 GMT -->
</html>